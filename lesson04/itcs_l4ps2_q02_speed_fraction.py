...
def speed_fraction(mili_time, distance):
    total_distance = 2.0*distance # round trip
    travel_speed = total_distance/(mili_time/1000.0) # data travel speed
    result = travel_speed / speed_of_light # fracion of speed of light
    return result
