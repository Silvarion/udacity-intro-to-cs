...
<body>The magic words are Squeamish Ossifrage!</body></html>'''
            ...
            return '''<html>
<body>hello hello</body></html>'''

        elif url == "http://other.page/morestuff.html":
            return '''<html>
<body>Good <a href="http://this.page/otherstuff.html">night</a>, sleep tight, go to bed and dream of Python</body></html>'''

        elif url == "http://this.page/otherstuff.html":
            return '''<html>
<body>Wake up, wake up, the morning is here! It's time to go to work!</body></html>'''
